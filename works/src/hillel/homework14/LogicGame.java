    ...
    static void codeGame() throws IOException {
        ...
        if (numbersGames <= 0) {
            ...
            if (scoringComp > scoringUser) {
                ...
                WriteAndTime.write(WriteAndTime.time(ResManager.getString("dateAndTime")) +
                        ResManager.getString("name") + user.getName() + ResManager.getString("resultGameComputerWin") + scoringComp
                        + " : " + scoringUser + "\n================================================");
                ...
                WriteAndTime.write(WriteAndTime.time(ResManager.getString("dateAndTime")) +
                        ResManager.getString("name") + user.getName() + ResManager.getString("resultGameYouWin") + scoringUser
                        + " : " + scoringComp + "\n================================================");
                ...
                WriteAndTime.write(WriteAndTime.time(ResManager.getString("dateAndTime")) +
                        ResManager.getString("name") + user.getName() + ResManager.getString("resultGameDraw") + scoringComp
                        + " : " + scoringUser + "\n================================================");
